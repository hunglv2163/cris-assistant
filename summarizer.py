        ...
        response = await client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are a professional secretary. Your task is to **summarize and translate** daily work reports from a Telegram group into **concise Vietnamese**. "
                 ...
                 "- Ensure 100% accurate attribution of tasks to the correct user. DO NOT mix up reports between users.\n"
                 ...
                 "6. ACCURACY: Check the username carefully. If User A reports X, do NOT say User B did X.\n"
